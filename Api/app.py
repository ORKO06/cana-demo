...
def main():
    ...
    if flask.request.method == 'POST':
        ...
        N_Default_L3m=data['N_Default_L3m']
        Max_Utilization=data['Max_Utilization']
        Max_Perc_Def_Chg_Pending=data['Max_Perc_Def_Chg_Pending']
        N_Family_Member=data['N_Family_Member']
        N_PosBkt_L3m=data['N_PosBkt_L3m']
        Ever_Default_L12M=data['Ever_Default_L12M']
        Perc_Paymode_Online=data['Perc_Paymode_Online']
        Perc_Repay_Fail=data['Perc_Repay_Fail']
        Max_DPD_L3m=data['Max_DPD_L3m']
        Perc_Paymode_Cheq_Fail=data['Perc_Paymode_Cheq_Fail']
        Age=data['Age']
        N_Enq_L9m=data['N_Enq_L9m']
        Max_Loan_Balance_Others=data['Max_Loan_Balance_Others']
        N_WorkEx_Yr=data['N_WorkEx_Yr']
